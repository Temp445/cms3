...
const Features = () => {
  return (
    <div className="py-10 md:py-16  bg-slate-200 mt-12 md:mt-20" id="features">
      <div className="max-w-7xl px-4 sm:px-6 lg:px-8 container mx-auto relative">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800">
            What We Offer
          </h2>
          <p className="md:text-lg text-gray-800 max-w-5xl mx-auto text-justify md:text-center">
