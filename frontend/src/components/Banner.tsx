...
const Banner = () => {
  ...
  return (
         <div className='bg-slate-200 mt-8 md:mt-10'>
      ...
      <div className="lg:w-1/2 text-center lg:text-left space-y-4">
        <h1 className=" text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-bold  lg:block   text-black ">
        ...
        <p className="text-gray-900  text-base md:text-lg text-justify 2xl:w-11/12">
    ...
    <div className='mt-5 md:mt-10'> 
        <Link href="/signin" className=" text-sm md:text-base  mt-4 p-1.5 md:p-0 md:px-3 md:py-2 border border-black text-black hover:border-[#071952] hover:text-white rounded shadow-lg hover:bg-[#071952]  transition">
          Tap to enter
        </Link>
    </div>
      </div>
