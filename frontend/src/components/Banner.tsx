...
const Banner = () => {
  ...
  return (
         <div className='bg-[#210F37] mt-8 md:mt-10'>
        ...
        <div className="min-h-fit  flex flex-col lg:flex-row items-center justify-center p-6 py-5 px-10  container mx-auto relative">
         ...
         <div className='hidden lg:block absolute w-10 h-10 border border-gray-600 z-10 top-20 left-20 rotate-45'></div>
         ...
         <div className='hidden lg:block absolute w-3 h-3  border border-gray-600 z-10 lg:top-20 xl:top-10 left-72 rounded-full'></div>
         <div className='hidden lg:block absolute w-10 h-32 border border-gray-600 z-10 top-5  xl:left-[600px]  rounded-full rotate-90'></div>
         ...
         <div className='hidden lg:block absolute w-2 h-10 border border-gray-600 z-10 top-28 left-96 rotate-90 rounded-full '></div>
      ...
      <div className="lg:w-1/2 text-center lg:text-left space-y-4">
        <h1 className=" text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-bold  lg:block   text-white ">
          Access Anytime via <span className='flex text-center lg:text-left lg:justify-start mx-auto justify-center  '><span className='bg-clip-text text-transparent bg-red-500  font-bold'>Android Devices</span>  <Image src={icon} alt="icon" className='w-6 h-6 md:w-10 mt-2 md:h-10 ml-2' /></span>
        </h1>
    ...
    <div className='mt-5 md:mt-10'> 
        <Link href="/signin" className=" text-sm md:text-base  mt-4 p-1.5 md:p-0 md:px-3 md:py-2 border border-white text-white hover:border-orange-600 hover:text-white rounded shadow-lg hover:bg-orange-600  transition">
          Tap to enter
        </Link>
    </div>
      </div>
