  ...
  return (
    <div className="container mt-5 md:mt-12 mx-auto">
      ...
      <div className="w-full  flex  justify-center container mx-auto p-4 ">
        <div className="relative w-full max-w-5xl bg-[#0d37c0] p-0.5 rounded-xl">
          <Image
            src={CMS}
            alt="CMS"
          ...
          <button
            ...
            className="absolute inset-0 m-auto flex items-center justify-center gap-1 md:gap-2 px-3 py-2 md:px-6 md:py-3 bg-[#071952] text-white rounded-full  transition-transform hover:scale-105 shadow-lg w-max h-max animate-pulse"
