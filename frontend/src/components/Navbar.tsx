    ...
    <>
      <nav className="flex items-center justify-between md:pt-5 lg:pb-10 px-4 md:px-0 lg:px-6 relative">
        ...
        <div className="hidden md:flex items-center space-x-2">
          <Link
            href="#features"
            className="flex items-center text-gray-800 hover:text-white text-base font-semibold relative px-4 py-2 rounded-full transition-all duration-300 ease-in-out hover:bg-[#071952]"
          >
